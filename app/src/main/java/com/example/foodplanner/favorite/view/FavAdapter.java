...
public class FavAdapter extends RecyclerView.Adapter<FavAdapter.ViewHolder> {
    ...
    Context context;
    FavoriteViewConnector favoriteViewConnector;

    public FavAdapter(Context context,FavoriteViewConnector favoriteViewConnector) {
        this.context = context;
        this.favoriteViewConnector=favoriteViewConnector;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.favDeleteBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                favoriteViewConnector.deleteFavMeal(dbMeal);
            }
        });
        holder.fav_card_view.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                favoriteViewConnector.getMealAndAvigate(dbMeal);
            }
        });
